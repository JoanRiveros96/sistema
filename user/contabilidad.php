<?php 
    ...
    $contabilidad ="SELECT * FROM `empleados`  WHERE Activo = 1 AND Dependencia ='Contabilidad' ";
...
<section>
  ...
  <div class="w3-container">
    ...
    <?php $contabilidad = mysqli_query($mysqli,$contabilidad); 
  $i=0; 
  while($rowNot=mysqli_fetch_assoc($contabilidad)){
    if($i%2==0){?>
    <div class="rowinfo">
      <div class="info1"> <img class="img-fluid" src="../storage/app/public/<?php echo $rowNot["Foto"]?>"  ></div>
    <div class="info2">
      <h2 class ="wrapper dep"><?php echo utf8_encode($rowNot["Dependencia"])?></h2>
  <p class ="wrapper">
  <?php  
