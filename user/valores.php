<?php 
    ...
    $valores ="SELECT * FROM `colegios` WHERE TipoInfo='Valores y Principios pedagógicos';";
...
<?php $valores = mysqli_query($mysqli,$valores); 
  ...
  <div class="imgCol"> <img class="img-fluid imgCol" src="../public/storage/<?php echo $rowNot["Imagen"]?>" style=" height:600px; width:300px; "></div>
  <?php 
  }?>
  </section>
