<?php 
    ...
    $manual ="SELECT * FROM `colegios` WHERE TipoInfo='Manual de Convivencia';";
...
<?php $manual = mysqli_query($mysqli,$manual); 
  ...
  <div class="imgCol"> <img class="img-fluid imgCol" src="../public/storage/<?php echo $rowNot["Imagen"]?>" style=" height:800px; width:600px; "></div>
  <?php 
  }?>
  </section>
