<?php 
    ...
    $manual ="SELECT * FROM `colegios` WHERE Activo = 1 AND TipoInfo='Manual de Convivencia';";
...
<?php $manual = mysqli_query($mysqli,$manual); 
  ...
  <div class="imgCol"> <img class="img-fluid imgCol" src="../storage/app/public/<?php echo $rowNot["Imagen"]?>" style=" height:800px; width:600px; "></div>
  <?php 
  }?>
  </section>
