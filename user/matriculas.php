<?php 
    ...
    $matricula ="SELECT * FROM `matriculas` WHERE Activo = 1 ORDER by updated_at asc";
...
<section style="background:#00477e;">
  ...
  <div class="w3-container">
    ...
    <?php $matricula = mysqli_query($mysqli,$matricula); 
  
  while($rowNot=mysqli_fetch_assoc($matricula)){?>
