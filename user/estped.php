<?php 
    ...
    $estped ="SELECT * FROM `colegios` WHERE TipoInfo='Estrategia Pedagógica';";
...
<?php $estped = mysqli_query($mysqli,$estped); 
  ...
  <div class="imgCol"> <img class="img-fluid imgCol" src="../public/storage/<?php echo $rowNot["Imagen"]?>" style=" height:700px; width:750px; "></div>
  <?php 
  }?>
  </section>
