<?php 
    ...
    $estped ="SELECT * FROM `colegios` WHERE Activo = 1 AND TipoInfo='Estrategia Pedagogica'";
?>
...
<section>
<?php $estped = mysqli_query($mysqli,$estped); 

  while($rowNot=mysqli_fetch_assoc($estped)){?>
  ...
  <div class="imgCol"> <img class="img-fluid imgCol" src="../storage/app/public/<?php echo $rowNot["Imagen"]?>" style=" height:700px; width:750px; "></div>
  <?php 
  }?>
  </section>
