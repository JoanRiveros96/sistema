<?php 
    ...
    $historias ="SELECT * FROM `historias` ORDER by updated_at asc";
...
<section>
  <div class="title">TRAYECTORIA INSTITUCIONAL</div>
  </section>
...
<section style="background:#00477e;">
  ...
  <div class="w3-container">
    ...
    <?php $historias = mysqli_query($mysqli,$historias); 
  
  while($rowNot=mysqli_fetch_assoc($historias)){?>
...
<?php if($rowNot["Imagen"]!=null){?>
      <div class="w3-third" style="height:100%; width:100%"> <img class="img-fluid" src="../public/storage/<?php echo $rowNot["Imagen"]?>"  ></div>
      <?php
  }?>
