<?php 
    ...
    $himno ="SELECT * FROM `colegios` WHERE TipoInfo='HIMNO DEL COLEGIO INTEGRADO NUESTRA SEÑORA DEL DIVINO AMOR';";
    $bandera ="SELECT * FROM `colegios` WHERE TipoInfo='Bandera del Colegio';";
    $escudo ="SELECT * FROM `colegios` WHERE TipoInfo='Escudo del Colegio';";
