<?php 
    ...
    $gescal ="SELECT * FROM `colegios` WHERE TipoInfo='Gestión y Política de calidad';";
...
<?php $gescal = mysqli_query($mysqli,$gescal); 
  ...
  <div class="imgCol"> <img class="img-fluid imgCol" src="../public/storage/<?php echo $rowNot["Imagen"]?>" style=" height 1000px; width:1400px; "></div>
  <?php 
  }?>
  </section>
