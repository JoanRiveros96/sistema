<?php 
    ...
    $dependencia ="SELECT * FROM `empleados` WHERE (Activo = 1) AND  (Dependencia ='Rectoria 'OR Dependencia = 'Coordinacion Academica' OR Dependencia = 'Secretaria')";
...
<section>
  ...
  <div class="w3-container">
    ...
    <?php $dependencia = mysqli_query($mysqli,$dependencia); 
  $i=0; 
  while($rowNot=mysqli_fetch_assoc($dependencia)){
    if($i%2==0){?>
    <div class="rowinfo">
